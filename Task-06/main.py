...
if table_exist:
    ...
    table_ini = "create table USER_AUTH (id integer primary key, user_id varchar(255), hashed_password varchar(255));"
...
def login():
    ...
    for i in auth_table_data:
        if username.lower() == i[1] and bcrypt.checkpw(password.encode('utf-8'),i[2].encode('utf-8')):
        ...
        elif username.lower() == i[1] or bcrypt.checkpw(password.encode('utf-8'),i[2].encode('utf-8')):
            return jsonify({
                "status": "error",
